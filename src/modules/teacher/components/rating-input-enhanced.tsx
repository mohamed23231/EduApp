...
const styles = StyleSheet.create({
  ...
  compactBadge: { alignItems: 'center', backgroundColor: colors.neutral.paper, borderColor: '#E5E7EB', borderRadius: 8, borderWidth: 1, height: 32, justifyContent: 'center', minWidth: 52, paddingHorizontal: 10 },
  ...
  presetButton: { alignItems: 'center', backgroundColor: colors.neutral.paper, borderColor: '#E5E7EB', borderRadius: 8, borderWidth: 1, flex: 1, height: 40, justifyContent: 'center' },
