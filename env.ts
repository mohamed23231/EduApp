...
const BUNDLE_IDS = {
  development: 'com.privatedu.mobile.development',
  preview: 'com.privatedu.mobile.preview',
  production: 'com.privatedu.mobile',
} as const;
...
const SCHEMES = {
  development: 'privatedu',
  preview: 'privatedu.preview',
  production: 'privatedu',
} as const;

const NAME = 'Privat Edu';
